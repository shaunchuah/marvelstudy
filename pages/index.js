...
export default function Home() {
  return (
    <main className="flex flex-col items-center w-full flex-1">
      <section className="px-4 flex md:flex-row flex-col gap-8 py-4 md:py-24 items-center">
        <div className="pl-16 md:w-1/2 flex-none flex flex-col md:items-start md:text-left items-center">
          <Image
          ...
          <a
            className="p-2 mt-24 text-gray-500 hover:text-[#008000]"
